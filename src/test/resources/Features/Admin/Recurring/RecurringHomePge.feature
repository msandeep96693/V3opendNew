Feature: Recurring Home page
  ...
  Background:
   ...
   @Smoke
   Scenario: The admin filters the recurrings by status and verifies the results in the table
   ...
   @Smoke 
   Scenario: The admin filters the recurrings by campaign type and verifies the results in the table
   ...
   @Smoke 
   Scenario: The admin filters the recurrings by Campaign Mode and verifies the results in the table
   ...
   @Sanity
   Scenario: The admin filters the recurrings by Advertiser and verifies the results in the table
   ...
   #End to End testing the recurrings by all the filters
   @Regression
   Scenario: The admin filters the recurrings by all filters and verifies the results in the table
    When The admin selects "Scheduled" from the "All Status" filter dropdown
    Then Verify the table should display only campaigns with the status "Scheduled" from "Status" column
